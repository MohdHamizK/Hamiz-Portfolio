        ...
        <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                I have completed relevant coursework in Python Programming, Microsoft Excel, Oracle SQL, Database Management, and various SQL variants including PSQL, MYSQL, and MS SQL. My journey in data analytics is supported by a strong foundation in these technical skills.
              </p>
              <p className="text-gray-500 dark:text-gray-400">
