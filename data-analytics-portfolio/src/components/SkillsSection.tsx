...
export function SkillsSection() {
  const technicalSkills = [
    { name: "Python", level: 70, icon: <CodeIcon className="h-5 w-5 text-blue-500" /> },
    { name: "Java", level: 65, icon: <CodeIcon className="h-5 w-5 text-red-500" /> },
    { name: "SQL", level: 90, icon: <DatabaseIcon className="h-5 w-5 text-green-500" /> },
    { name: "Speech Recognition", level: 75, icon: <CodeIcon className="h-5 w-5 text-purple-500" /> },
    { name: "AI Automation", level: 80, icon: <CodeIcon className="h-5 w-5 text-yellow-500" /> },
    { name: "Microsoft Excel", level: 95, icon: <TableIcon className="h-5 w-5 text-green-500" /> },
    { name: "Power BI", level: 95, icon: <BarChartIcon className="h-5 w-5 text-blue-500" /> },
    { name: "Tableau", level: 90, icon: <BarChartIcon className="h-5 w-5 text-orange-500" /> },
  ];
